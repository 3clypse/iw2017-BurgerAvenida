...
@UIScope
@SpringView(name = ZoneView.VIEW_ROUTE)
public class ZoneView extends VerticalLayout implements View {
	...
	public static final String VIEW_ROUTE = "ZoneView";
	public static final String VIEW_NAME = "ZoneView";
	...
	void init() {
		...
		grid.setSizeFull();
		grid.setColumns("type", "description", "restaurant");
		...
		addNewBtn.addClickListener(e -> editor.edit(new Zone()));
    ...
    void list(String filterText) {
		if (StringUtils.isEmpty(filterText)) {
			grid.setItems((Collection<Zone>) repo.findAll());
		}
		else {
