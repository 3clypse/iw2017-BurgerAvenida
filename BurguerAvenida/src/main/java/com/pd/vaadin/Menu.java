...
public class Menu extends CssLayout {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -8917191732125876870L;
    ...
    public Menu(Navigator navigator) {
        ...
        logoutMenu.addItem("Logout", VaadinIcons.SIGN_OUT, new Command() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -959658677218751888L;
        ...
        final Button showMenu = new Button("Menu", new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -8529294082352927333L;
    ...
    private void createViewButton(final String name, String caption,
        ...
        Button button = new Button(caption, new ClickListener() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -6522682720461535742L;
